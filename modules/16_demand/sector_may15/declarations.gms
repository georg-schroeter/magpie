...
vm_excess_waste(i,kall)           Excess waste without actual demand (mio. tDM per yr)
;
...
parameters
 ...
 ov_excess_waste(t,i,kall,type)           Excess waste without actual demand (mio. tDM per yr)
