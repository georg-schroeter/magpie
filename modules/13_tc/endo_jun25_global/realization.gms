...
$Ifi "%phase%" == "sets" $include "./modules/13_tc/endo_jun25_global/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/13_tc/endo_jun25_global/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/13_tc/endo_jun25_global/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/13_tc/endo_jun25_global/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/13_tc/endo_jun25_global/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/13_tc/endo_jun25_global/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/13_tc/endo_jun25_global/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/13_tc/endo_jun25_global/postsolve.gms"
$Ifi "%phase%" == "nl_fix" $include "./modules/13_tc/endo_jun25_global/nl_fix.gms"
$Ifi "%phase%" == "nl_release" $include "./modules/13_tc/endo_jun25_global/nl_release.gms"
$Ifi "%phase%" == "nl_relax" $include "./modules/13_tc/endo_jun25_global/nl_relax.gms"
