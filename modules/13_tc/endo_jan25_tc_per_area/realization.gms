...
$Ifi "%phase%" == "sets" $include "./modules/13_tc/endo_jan25_tc_per_area/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/13_tc/endo_jan25_tc_per_area/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/13_tc/endo_jan25_tc_per_area/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/13_tc/endo_jan25_tc_per_area/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/13_tc/endo_jan25_tc_per_area/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/13_tc/endo_jan25_tc_per_area/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/13_tc/endo_jan25_tc_per_area/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/13_tc/endo_jan25_tc_per_area/postsolve.gms"
$Ifi "%phase%" == "nl_fix" $include "./modules/13_tc/endo_jan25_tc_per_area/nl_fix.gms"
$Ifi "%phase%" == "nl_release" $include "./modules/13_tc/endo_jan25_tc_per_area/nl_release.gms"
$Ifi "%phase%" == "nl_relax" $include "./modules/13_tc/endo_jan25_tc_per_area/nl_relax.gms"
