...
$Ifi "%tc%" == "endo_global_may26" $include "./modules/13_tc/endo_global_may26/realization.gms"
$Ifi "%tc%" == "endo_jan22" $include "./modules/13_tc/endo_jan22/realization.gms"
$Ifi "%tc%" == "endo_tcstock_jan26" $include "./modules/13_tc/endo_tcstock_jan26/realization.gms"
