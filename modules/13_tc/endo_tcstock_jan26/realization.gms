...
$Ifi "%phase%" == "sets" $include "./modules/13_tc/endo_tcstock_jan26/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/13_tc/endo_tcstock_jan26/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/13_tc/endo_tcstock_jan26/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/13_tc/endo_tcstock_jan26/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/13_tc/endo_tcstock_jan26/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/13_tc/endo_tcstock_jan26/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/13_tc/endo_tcstock_jan26/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/13_tc/endo_tcstock_jan26/postsolve.gms"
$Ifi "%phase%" == "nl_fix" $include "./modules/13_tc/endo_tcstock_jan26/nl_fix.gms"
$Ifi "%phase%" == "nl_release" $include "./modules/13_tc/endo_tcstock_jan26/nl_release.gms"
$Ifi "%phase%" == "nl_relax" $include "./modules/13_tc/endo_tcstock_jan26/nl_relax.gms"
