...
q13_rd_stock_global..
  v13_rd_stock_per_area_global("crop") * sum(i2, pc13_land(i2,"crop")) =e= sum(i2, vm_rd_stock_per_area(i2, "crop") * pc13_land(i2,"crop"));
...
q13_tech_cost_init(t_past, i2)..
    (sum(supreg(h2,i2),v13_tau_init(t_all, h2)))**(i13_tc_exponent("y1995")/0.85) =e= 
    (1-s13_tc_investment_global_share) * (v13_rd_stock_per_area_init(t_all, i2) * sum(ct, i13_tc_exponent("y1995") / i13_tc_factor("y1995")))**(1/0.85) +
    s13_tc_investment_global_share * (v13_rd_stock_per_area_global_init(t_all) * sum(ct, i13_tc_exponent("y1995") / i13_tc_factor("y1995")))**(1/0.85);
