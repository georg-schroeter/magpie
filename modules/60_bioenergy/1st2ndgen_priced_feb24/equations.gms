...
q60_bioenergy_incentive(i2).. vm_bioenergy_utility(i2)
  =e= sum(ct, v60_sub_a(i2) * (-i60_1stgen_bioenergy_subsidy(ct)))
  + sum(ct, v60_sub_b(i2) * (-i60_2ndgen_bioenergy_subsidy(ct)));

q60_sub_a(i2) ..
  v60_sub_a(i2) =e= sum(k1st60, vm_dem_bioen(i2,k1st60) * fm_attributes("ge",k1st60));

q60_sub_b(i2) ..
  v60_sub_b(i2) =e= sum(kbe60, vm_dem_bioen(i2,kbe60) * fm_attributes("ge",kbe60));
